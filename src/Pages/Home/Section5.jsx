        ...
        >
            <Box sx={{ maxWidth: "1200px", width: "100%", mx: "auto" }}>
                ...
                >
                    ...
                    <MotionButton
                        onClick={() => navigate("/case-studies")}   // ✅ navigation added
                        initial={{ opacity: 0, y: 22 }}
                        whileInView={{ opacity: 1, y: 0 }}
                ...
                >
                    {caseStudies.map((item, index) => (
                        ...
                        >
                            ...
                            >
                                <Typography sx={{ color: "#00D9FF", fontSize: "12px", letterSpacing: "3px", textTransform: "uppercase", mb: "18px" }}>
                                    {item.category}
                                </Typography>

                                <Typography sx={{ fontSize: { xs: "19px", md: "20px" }, lineHeight: "26px", fontWeight: 500, color: "#E9ECF7", mb: "18px" }}>
                                    {item.title}
                                </Typography>
                                ...
                                <Typography sx={{ color: "#00D9FF", fontSize: "16px", lineHeight: "24px", fontWeight: 500, mb: "26px" }}>
                                    {item.highlight}
                                </Typography>
                                ...
                                <Box sx={{ display: "grid", gridTemplateColumns: "repeat(2, minmax(0, 1fr))", gap: "18px" }}>
                                    {item.metrics.map((metric) => (
                                        <Box key={metric.label}>
                                            <Typography sx={{ fontSize: { xs: "24px", md: "26px" }, fontWeight: 500, color: "#E9ECF7" }}>
                                                {metric.value}
                                            </Typography>
